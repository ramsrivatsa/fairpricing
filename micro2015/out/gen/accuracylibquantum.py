...
fList6 = [s.strip() for s in open('../../papergraphs/accuracy/libquantumcorunner/snapshot/%s.txt' % filename).readlines()]
...
mars_awesome_plt.savefig('accuracylibquantum.eps', bbox_inches='tight');
mars_awesome_os.popen('epstopdf accuracylibquantum.eps');
